...
COMPONENT_FILES	:= ark.sv ATD_block.sv atd_detector.sv controller.sv data_mux.sv
COMPONENT_FILES	+= data_ready.sv data_register.sv decode.sv encryption.sv encryption_mux.sv
COMPONENT_FILES	+= encryptor_lcu.sv flex_counter.sv flex_pts_sr.sv flex_stp_sr.sv i2c.sv
COMPONENT_FILES	+= keygen.sv key_register.sv mc.sv rx_reg.sv rx_sr.sv sb.sv scl_edge.sv
COMPONENT_FILES	+= sda_sel.sv sr.sv stp.sv sync_high.sv timer.sv tx_fifo.sv tx_sr.sv
#COMPONENT_FILES        := flex_counter.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= AESencryptor.sv
#TOP_LEVEL_FILE	:= data_ready.sv
